...
const help = defineCommand({
  ...
  async run() {
    ...
    consola.log(`  ${pc.cyan("sdd mcp sources add …")}  attach design-system / AST / org MCP for sdd to call`);
    consola.log(`  ${pc.cyan("sdd mcp fetch")}            pull matching MCP context for current stage`);
